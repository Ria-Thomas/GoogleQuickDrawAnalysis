#
# This file is used for Using Random Forest Classifier 
# The insight of providing the details of Using Random Forest Classifier on the given dataset interms pediction for the dataset.
# 
# Here is the way to run the file: ${SPARK_HOME}/bin/spark-submit --packages org.mongodb.spark:mongo-spark-connector_2.11:2.4.1 insight_ml1.py
#
