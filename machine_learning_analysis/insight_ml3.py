#
# This file is used for Using Decision Tree Classifier
# The insight of providing the details of Using Decision Tree Classifier on the given dataset interms pediction for the dataset.
# 
# Here is the way to run the file: ${SPARK_HOME}/bin/spark-submit --packages org.mongodb.spark:mongo-spark-connector_2.11:2.4.1 insight_ml3.py
#
...
# Nov 29 2019 - Code formatting and edited the mongodb collection 
