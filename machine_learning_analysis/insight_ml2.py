#
# This file is used for Using K-Nearest Neighbour Classification
# The insight of providing the details of Using K-Nearest Neighbour Classification on the given dataset interms pediction for the dataset.
# 
# Here is the way to run the file: ${SPARK_HOME}/bin/spark-submit --packages org.mongodb.spark:mongo-spark-connector_2.11:2.4.1 insight_ml2.py
#
...
# Nov 29 2019 - Code formatting and edited the mongodb collection - riat
...
def main():
   ...
   print("Using K-Nearest Neighbour Classification")
   ...
   print("Confusion matrix for the K-Nearest Neighbour Classification")
